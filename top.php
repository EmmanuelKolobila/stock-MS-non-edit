          ...
          <div class="main_nav">
            <div class="top_nav">
              <ul class=" ">
                <li class="">
                  <a class="" href="">
                    <img src="images1/telephone.png" alt="" />
                    <span> +01 1234567890</span>
                  </a>
                </li>
                <li class="">
                  <a class="" href="">
                    <img src="images1/mail.png" alt="" />
            ...
            <div class="bottom_nav" style="background-color: blue">
              <nav class="navbar navbar-expand-lg custom_nav-container">
                ...
                <div style="background-color: red" class="collapse navbar-collapse" id="navbarSupportedContent">
